...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo get_stylesheet_directory_uri(); ?>/styles/style_default.css" />
		 <?php else: ?>
...
<?php endif; ?>
<link rel="stylesheet" type="text/css" media="print" href="<?php echo get_stylesheet_directory_uri(); ?>/styles/print.css" />
<!--[if lt IE 9]>
...
<!-- LOGO BLOCK STARTS HERE -->
  <div id="logo">   
    <a href="<?php echo home_url(); ?>/"><img style="border:none;padding:0;" src="http://beta.minesmagazine.com/wp-content/uploads/2013/07/MMLogo.png" /></a>
  </div><!-- end #logo -->
